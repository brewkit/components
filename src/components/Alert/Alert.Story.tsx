...
export const Sandbox: Story<AlertProps> = function storySandbox(args) {
    return <Alert {...args} />;
};
Sandbox.args = {
    title: 'I am an alert!',
...
export const General: Story<AlertProps> = function storyGeneral() {
    return (
...
export const Filled: Story<AlertProps> = function storyFilled() {
    return (
        <div style={{ display: 'grid', gridGap: '1rem' }}>
            <Alert
                severity="error"
...
export const WithDescription: Story<AlertProps> = function storyWithDesc() {
    return (
        <div style={{ display: 'grid', gridGap: '1rem' }}>
