...
const defaultArgs = {
    ...
    getOptionLabel: (option: unknown): string =>
        (option as FilmOptionType).title,
};
...
export const Sandbox: Story<AutocompleteProps<unknown, false, false, false>> =
    function sandbox(args): React.ReactElement {
...
export const General: Story<ButtonProps> = function general(args) {
    return <Button {...args} />;
};
...
export function Types(): React.ReactElement {
    return (
        <div style={{ display: 'grid', gridGap: '1rem' }}>
            ...
            <Autocomplete {...flatArgs} id="flat-demo" label="flatDemo" />
