...
function Button(_a) {
    ...
    return (react_1["default"].createElement(react_flip_toolkit_1.Flipper, { flipKey: JSON.stringify([isLoading, variant, color, size]) }, react_1["default"].createElement(react_flip_toolkit_1.Flipped, { flipId: "wrapper" }, react_1["default"].createElement("button", __assign({ "aria-label": (variant === 'icon' && typeof children === 'string') ? children : undefined, className: buttonClasses, disabled: isDisabled || isLoading, type: "button" }, otherProps), react_1["default"].createElement(react_flip_toolkit_1.Flipped, { flipId: "content" }, react_1["default"].createElement("div", { className: "brew-Button__content" }, react_1["default"].createElement(Typography_1["default"], { className: "brew-Button__text" }, children), variant === 'icon' && typeof children === 'string' &&
        react_1["default"].createElement(Icon_1["default"], { className: "brew-Button__icon", color: "inherit" }, children))), react_1["default"].createElement(react_flip_toolkit_1.Flipped, { flipId: "loader" }, react_1["default"].createElement("div", { className: "brew-Button__loadingIndicator" }, react_1["default"].createElement(Progress_1["default"], { color: color, variant: "circular" })))))));
}
