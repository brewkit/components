...
var StandardStatusCard = function (_a) {
    ...
    return (react_1["default"].createElement("div", __assign({ className: standardClasses }, otherProps), react_1["default"].createElement("section", { className: "icon" }, react_1["default"].createElement(Icon_1["default"], { color: color }, icon)), react_1["default"].createElement("section", null, react_1["default"].createElement(Typography_1["default"], { color: color, variant: "h1" }, header), react_1["default"].createElement(Typography_1["default"], { color: color, variant: "body1" }, body))));
};
