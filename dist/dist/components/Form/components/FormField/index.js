...
function FormField(_a) {
    ...
    return (react_1["default"].createElement(FormGroup_1["default"], { className: classes }, label && (react_1["default"].createElement(FormLabel_1["default"], null, label)), react_1["default"].createElement(Input_1["default"], __assign({ className: inputClassName, variant: variant }, otherProps)), helperText && (react_1["default"].createElement(FormHelperText_1["default"], null, helperText))));
}
