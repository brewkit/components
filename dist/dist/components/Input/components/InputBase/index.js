...
var InputBase = function (_a) {
    ...
    var Element = as;
    return (react_1["default"].createElement(Typography_1["default"], __assign({ as: "label", className: classes }, otherProps), before, react_1["default"].createElement(Element, { checked: checked, className: clsx_1["default"]('brew-Input__element', inputClassName), cols: cols, defaultChecked: defaultChecked, defaultValue: defaultValue, disabled: disabled, id: id, name: name, onChange: onChange, placeholder: placeholder, readOnly: readOnly, required: required, rows: rows, type: type, value: value }, children), after, Boolean(customControl) && customControl, inputLabel && (type === 'checkbox' || type === 'radio') && (react_1["default"].createElement("span", { className: clsx_1["default"]('brew-Input__label', inputLabelClassName) }, inputLabel))));
};
