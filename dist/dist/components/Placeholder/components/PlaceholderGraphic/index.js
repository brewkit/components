...
function PlaceholderGraphic(_a) {
    ...
    return (react_1["default"].createElement(Typography_1["default"], { className: placeholderClasses, as: "p", variant: "body1" }, react_1["default"].createElement(Icon_1["default"], { children: graphic })));
}
