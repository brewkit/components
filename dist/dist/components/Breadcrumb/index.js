...
function Breadcrumb(_a) {
    ...
    return (react_1["default"].createElement("div", { className: classes }, crumbs.map(function (crumb, index) {
        ...
        return (react_1["default"].createElement(react_router_dom_1.BrowserRouter, { key: index }, react_1["default"].createElement(Typography_1["default"], { variant: "body2" }, crumb.url && notLast
            ? (react_1["default"].createElement(react_router_dom_1.Link, { className: "brew-Breadcrumb__link", to: crumb.url }, crumb.title))
            : (react_1["default"].createElement(Typography_1["default"], { variant: "body2" }, crumb.title)), react_1["default"].createElement("span", { className: "brew-Breadcrumb__separator" }, divider
            ? notLast && divider
            : notLast && '/'))));
    })));
}
