...
var CompactStatusCard = function (_a) {
    ...
    return (react_1["default"].createElement("div", __assign({ className: compactClasses }, otherProps),
        react_1["default"].createElement(Typography_1["default"], { align: "center", color: color, variant: "body1" }, header),
        react_1["default"].createElement(Typography_1["default"], { align: "center", className: "cardBody", variant: "body1" }, body.toUpperCase())));
};
