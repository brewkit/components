...
function Banner(_a) {
    ...
    return (react_1["default"].createElement("div", __assign({ className: bannerClasses }, otherProps),
        iconName && (react_1["default"].createElement(BannerIcon_1["default"], { iconName: iconName, isLoading: isLoading })),
        (title || description) && (react_1["default"].createElement(BannerBody_1["default"], null,
            title && (react_1["default"].createElement(BannerTitle_1["default"], null, title)),
