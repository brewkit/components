...
function Label(_a) {
    ...
    return (react_1["default"].createElement("div", __assign({ className: classes }, otherProps),
        title && (react_1["default"].createElement("div", { className: "title" },
            react_1["default"].createElement(Typography_1["default"], { className: "titleContent", variant: "label" }, title))),
        react_1["default"].createElement("div", { className: "content" },
            react_1["default"].createElement(Typography_1["default"], { color: color, variant: "label" }, children))));
}
